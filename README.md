...
| 會不會寫錯 | **會。** 我們拿它排的一份行程抽查 31 項：22 項完全正確，價格沒有寫錯，但有幾處小地方不準——一家餐廳其實不能訂位、開放時間的月份區間寫錯、一句轉乘備註寫得會讓人誤會 | **會。** 我們測的時候，它把一段地鐵轉乘憑記憶寫錯了，後來只改好其中一天 |
...
- **AI 會查錯，資料也會過時。** 我們抽查過它排的行程，大部分是對的，但還是有小地方不準。
...
**例外：範例行程頁裡的照片**是微塵筆記自己在旅途中拍的，© 微塵筆記 DustyNotes，保留所有權利，不在 MIT 授權範圍內。
